...
| Candidate | Model type | Scale signal | Access | Best fit | Main limitation | Sources |
| --- | --- | --- | --- | --- | --- | --- |
...
| [pyannote Community-1](../../../../../../../software/sub/models/sub/pyannote/sub/speaker-diarization/sub/community-1/) | Speaker diarization model | Specialist | Gated local model | Speaker segmentation and transcript alignment | Does not transcribe or establish real-world identity; access, license, dependencies, overlap, and correction effort require review | [Model card](https://huggingface.co/pyannote/speaker-diarization-community-1) |
