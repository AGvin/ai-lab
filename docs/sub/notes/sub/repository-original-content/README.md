# Repository-Original Content and Research Candidates

This index tracks proposals first documented in this repository and separates repository provenance from claims of scientific or technical novelty.
...
`Repository-original` means that the named proposal or synthesis was authored for this repository rather than copied as a page from an identified external source. It does **not** mean:

- first publication;
- absence of prior art;
- patentable or academic novelty;
- implementation;
- validation;
- safety, quality, reliability, or economic superiority;
- production readiness.

Git history records technical provenance. Concept pages should use neutral status metadata and public evidence rather than personal-name authorship markers.

## Current index

### Integrated Agent Organization and Resource Portfolio

- **Page:** [Integrated Agent Organization and Resource Portfolio](../concepts/sub/agents-and-automation/sub/multi-agent-systems/sub/integrated-agent-organization-and-resource-portfolio/)
- **Origin:** Repository-original proposal.
- **Status:** Research candidate.
- **Implementation:** None.
- **Validation:** None.
- **Production use:** No.
- **Evidence:** Design analysis and an initial bounded public-literature comparison completed on 2026-07-25.
...
- Archive or narrow unsupported novelty scopes rather than defending them through wording.
