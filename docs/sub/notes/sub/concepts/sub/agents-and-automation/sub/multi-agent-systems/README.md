...
## Remaining unresolved research candidate

[Integrated Agent Organization and Resource Portfolio](./sub/integrated-agent-organization-and-resource-portfolio/) remains a repository-origin research candidate with an initial bounded literature review, no implementation or validation, and no novelty claim.

Do not promote it into canonical concept or learning truth and do not recommend it as an established architecture until an explicit research/provenance owner is selected and its evidence/novelty/validation boundary is reviewed.

This root remains migration source material only because that child has not yet received an exact durable disposition.
