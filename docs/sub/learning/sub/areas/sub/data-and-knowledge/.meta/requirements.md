...
- The area owns reusable data/retrieval learning rather than concrete product catalogs.
- Current navigation exposes only materialized selected children.
- Source/provenance and lifecycle are preserved for derived retrieval and knowledge state.
- Mutable backend/product behavior is not frozen as timeless learning truth.
