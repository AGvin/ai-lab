...
- Materialize only selected children with source-backed content; this package materializes `compression/` with Distillation and Pruning.
...
- Measure realized quality/resource behavior on the actual deployment/runtime path rather than inferring improvement from parameter count, nominal sparsity, theoretical FLOPs, or artifact size alone.
...
- Nominal compression is not equated with realized acceleration or lower end-to-end cost.
