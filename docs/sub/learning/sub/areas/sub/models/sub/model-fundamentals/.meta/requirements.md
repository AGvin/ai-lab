...
- Teach Model Fundamentals as the practical vocabulary needed to reason about model identity, artifacts, families, scales, variants, parameters, inputs, and lifecycle choices before architecture- or runtime-specific depth.
