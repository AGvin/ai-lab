...
- Make `using-agent-skills/` and `creating-agent-skills/` visible as the current source-backed learning children and explain their outcomes.
...
- Keep concrete skills/collections/registries/installers/platform support facts catalog/platform/evidence-owned; later portability learning can compare them with current sources.
...
- A reader can choose whether to learn skill adoption or skill creation without confusing Agent Skills with Plugins or MCP.
