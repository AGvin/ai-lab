...
- Explain that the current materialized subset focuses on `workflow-design/` because human-review/approval legacy material has source-backed practical workflow teaching ready for migration.
...
- The area remains product-neutral and transferable rather than a catalog of assistant features.
- User/practitioner workflow teaching is distinguished from agent runtime engineering and model internals.
- Current navigation exposes only materialized selected children.
- Mutable product behavior remains source-backed rather than timeless learning truth.
