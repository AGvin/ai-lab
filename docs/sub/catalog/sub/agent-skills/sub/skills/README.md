...
> **Temporary catalog summary:** This overview is a placeholder for the RC structure and will be replaced by a reviewed skill taxonomy.

Canonical profiles for selected individual Agent Skills. A skill can be distributed by a collection, plugin, marketplace, or direct repository path without changing its primary identity.
