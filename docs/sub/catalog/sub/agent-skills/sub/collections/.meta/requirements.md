...
- List each materialized direct child exactly once: Anthropic Skills, Matt Pocock Skills, NVIDIA Skills, OpenAI Skills, Ponytail, and Superpowers.
...
- Navigation matches the six materialized direct children exactly.
