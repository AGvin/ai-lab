...
- List each materialized direct child exactly once: Alibaba Cloud Skills, Anthropic Skills, Agent Toolkit for AWS Skills, Azure Agent Skills, Cloudflare Skills, Google Agent Skills, Hugging Face Skills, Matt Pocock Skills, Microsoft Skills, NVIDIA Skills, OpenAI Skills, Ponytail, and Superpowers.
...
- Navigation matches the 13 materialized direct children exactly.
