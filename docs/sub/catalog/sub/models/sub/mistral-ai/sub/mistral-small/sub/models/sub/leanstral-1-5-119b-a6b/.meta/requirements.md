...
- Keep its 119B-total/6.5B-active architecture, multimodal support, context guidance, reasoning settings, and current Labs/API access source-scoped.
- Treat benchmarks, API routing, Vibe integration, deployment support, and future Leanstral revisions as freshness-sensitive.
