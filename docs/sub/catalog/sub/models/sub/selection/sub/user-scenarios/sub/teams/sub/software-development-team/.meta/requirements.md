...
- Keep coding-task candidate/ranking evidence in `decision-guides/software-development/` and agent-loop safeguards in `decision-guides/agents-and-automation/`; this scenario owns team-level adoption/routing/review economics.
