...
- Keep GPU-buying advice, hardware capacity-class design, runtime selection, and server architecture outside this model-selection scenario; link those owners only when needed as decision constraints.
