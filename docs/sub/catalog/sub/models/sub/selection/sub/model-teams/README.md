...
The legacy `pyannote/speaker-diarization-community-1` pipeline also appeared in these portfolios. It remains a non-model pipeline/software residual and is intentionally not listed as a model-team identity until its canonical owner exists.
