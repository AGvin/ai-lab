...
- Identify Qwen2.5-Coder 7B Instruct as a concrete instruction-tuned coding model in the Qwen2.5-Coder line.
...
- Preserve the Apache-2.0 license and text-input/text-output modality description from the legacy profile.
