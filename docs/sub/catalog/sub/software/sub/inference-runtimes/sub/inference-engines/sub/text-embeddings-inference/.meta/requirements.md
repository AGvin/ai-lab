...
- The Hugging Face/TEI `produces` / `produced-by` relation pair is physically present at both endpoints and semantically consistent.
- The page distinguishes the self-managed TEI runtime from Hugging Face hosted inference services.
