...
- Identify CodeRabbit as the AI code-review and development-workflow product represented by the canonical Code Review Tools profile at this path.
- Preserve its primary code-review role across pull requests, IDE/editor, and CLI workflows while also noting related planning and Slack-agent surfaces without reclassifying the product as a general coding agent.
- Preserve support for major Git hosting surfaces at a stable high level, including GitHub, GitLab, Azure DevOps, and Bitbucket, while keeping exact platform editions and integration requirements source-backed.
...
- The page keeps CodeRabbit under Code Review Tools and does not characterize it primarily as a standalone coding agent.
