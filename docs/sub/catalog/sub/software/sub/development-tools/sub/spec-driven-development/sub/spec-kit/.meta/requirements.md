...
- Identify GitHub Spec Kit as GitHub's open-source toolkit/CLI for Spec-Driven Development workflows around AI coding agents.
- Preserve the product boundary: Spec Kit is a development workflow harness, not itself a coding agent, editor, model, or general agent-orchestration runtime.
- Preserve the durable workflow from product intent through specification, clarification, technical planning, task decomposition, analysis/checklists, implementation, and reconciliation without freezing every current command name.
- Preserve durable project-artifact semantics at a high level: constitutions/principles, specifications, plans, tasks, research, data models, contracts, validation guidance, templates, and supporting scripts remain inspectable/version-controlled project artifacts.
