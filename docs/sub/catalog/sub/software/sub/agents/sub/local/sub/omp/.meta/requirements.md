...
- Represent the Pi lineage through the canonical `derived-from` relation and a reader-facing related link; keep OMP and Pi as separate software identities with independent repositories, releases, configuration, and maintenance.
...
- Include the official OMP site and repository.
- Link the canonical Can Bölük producer and Pi source software.

## Validation

- OMP is represented as a materially distinct Pi derivative, not as a Pi version or alias.
- The Pi relation resolves to the canonical sibling software node.
