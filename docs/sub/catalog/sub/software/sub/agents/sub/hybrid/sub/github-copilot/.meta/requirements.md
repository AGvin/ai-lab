...
- Identify GitHub Copilot as GitHub's AI development product spanning editor, terminal, GitHub, and agentic development workflows.
...
- Distinguish IDE/local agent experiences from GitHub Copilot cloud agent, which performs delegated repository work in GitHub-managed ephemeral development environments backed by GitHub Actions.
...
- Link the canonical GitHub, Inc. producer.

## Validation

- The page does not materialize GitHub Copilot cloud agent as a duplicate product identity.
- The page does not conflate IDE agent mode with GitHub Copilot cloud agent.
...
- The producer link resolves to the canonical GitHub, Inc. node.
