...
- Keep Pi distinct from unrelated products using the Pi name and from [OMP](../omp/), which is a separate derived product.
- Link the canonical Earendil Inc. maintainer profile.
...
- The Earendil relation resolves to the canonical producer node.
