...
- Preserve the OpenClaw Foundation as the canonical maintainer/steward through the `maintained-by` relation; do not reinterpret stewardship as product origination without separate evidence.
