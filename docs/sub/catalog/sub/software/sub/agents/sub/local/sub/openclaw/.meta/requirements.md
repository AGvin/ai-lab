...
- Preserve Peter Steinberger (`steipete`) as OpenClaw's original creator/producer together with the community, while keeping that origin provenance distinct from current OpenClaw Foundation governance/stewardship.
...
- Include the current official OpenClaw repository, site, documentation, and creator provenance reference.

## Validation

- The page distinguishes the OpenClaw assistant from its Gateway control-plane component.
- Peter Steinberger/community origin provenance remains distinct from current OpenClaw Foundation stewardship.
