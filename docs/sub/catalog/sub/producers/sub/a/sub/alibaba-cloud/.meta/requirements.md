...
- Identify Alibaba Cloud as a canonical producer organization in the catalog.
- Explain its organizational relationship to Alibaba Group and Qwen Team using validated relations rather than inferred ownership.
...
- Link Qwen Team through the canonical `has-part` relation.
