...
- The concrete model page records capabilities, model type, modalities, architecture where documented, context limits, deployment options, licensing, hardware requirements, limitations, evidence, and evaluation date.
