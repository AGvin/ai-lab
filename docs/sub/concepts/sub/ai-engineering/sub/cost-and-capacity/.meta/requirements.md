...
- Keep model-choice consequences linked to the canonical `decision-support/selection/models/` decision owner. This concept can explain cost/capacity variables and trade-offs but must not become a duplicate model recommendation tree.
