...
Model-domain view for one producer, focused on the model families or lines represented in Model Catalog.
...
Use for producer views under `catalog/models/<producer>/`.
